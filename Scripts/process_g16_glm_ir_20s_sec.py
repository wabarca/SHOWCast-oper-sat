...
"title_text": "GOES-19 GLM Descargas Eléctricas (20s) + Banda "+band, "title_size": 8, "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016),
