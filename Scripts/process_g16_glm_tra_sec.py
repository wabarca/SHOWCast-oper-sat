...
if (seconds == '00'):
    ...
    if (int(minutes) % acum_minutes == 0):
        ...
        file = []
        for filename in sorted(glob.glob(path_ch14+'GOES-R-CMI-Imagery//Band14//OR_ABI-L2-CMIPF-M*C14_G19*.nc')):
        ...
        "title_text": "GOES-19 GLM Descargas Eléctricas (Seguimiento) + Banda "+band, "title_size": 8, "title_x_offset": int(sizex * 0.01), "title_y_offset": sizey - int(sizey * 0.016),
        ...
        newax = fig.add_axes([0.9, 0.0, 0.10, 0.10], anchor='S', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
