...
if (seconds == '00'):
    ...
    if (int(minutes) % acum_minutes == 0):
        ...
        "title_text": "GOES-19 GLM Descargas Eléctricas - Densidad ("+str(acum_minutes)+" min) + Banda "+band, "title_size": 8, "title_x_offset": int(sizex * 0.01), "title_y_offset": sizey - int(sizey * 0.016),
        ...
        newax = fig.add_axes([0.9, 0.0, 0.10, 0.10], anchor='S', zorder=12) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
