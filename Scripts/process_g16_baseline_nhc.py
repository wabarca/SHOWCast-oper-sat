...
cb.set_label('[ '+variable_units+' ]', color='black', size=plot_config["cbar_labelsize"], weight='bold')
cb.ax.tick_params(axis='y', width = 0.5, colors='black',  labelsize=plot_config["cbar_labelsize"])
