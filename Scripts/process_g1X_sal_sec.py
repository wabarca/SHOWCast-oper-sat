...
#path_ch13 = ("..//Samples//OR_ABI-L2-CMIPF-M6C13_G19_s20192931650344_e20192931700064_c20192931700142.nc")
...
"title_text": "GOES-" + satellite[1:3] + " Saharan Air Layer (Capa de aire del Sahara)", "title_size": 8, "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.030),
...
# img2 = ax.imshow(data1, cmap='gray', vmin=0.1, vmax=0.40, alpha = 0.75, origin='upper', extent=img_extent, zorder=3)

#print("Second layer...")
# SECOND LAYER
# data2 = data1
# data2[data2 < 0.25] = np.nan
# img3 = ax.imshow(data2, cmap='gray', vmin=0.05, vmax=0.50, alpha = 0.75, origin='upper', extent=img_extent, zorder=4)

#print("Third layer...")
# Third LAYER
# data2 = data1
# data2[data2 < 0.30] = np.nan
# img4 = ax.imshow(data2, cmap='gray', vmin=0.05, vmax=0.50, alpha = 0.75, origin='upper', extent=img_extent, zorder=5)
...
ax.add_geometries(shapefile, ccrs.PlateCarree(), edgecolor=plot_config["countries_color"],facecolor='none',alpha = 0.5,linewidth=plot_config["countries_width"], zorder=6)

# Add continents
shapefile = list(shpreader.Reader(main_dir + '//Shapefiles//GSHHS_h_L1_clipped.shp').geometries())
ax.add_geometries(shapefile, ccrs.PlateCarree(), edgecolor=plot_config["continents_color"],facecolor='none',alpha = 0.5, linewidth=plot_config["continents_width"], zorder=7)
...
newax = fig.add_axes([0.908, 0.0, 0.10, 0.10], anchor='S', zorder=10) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
newax.imshow(my_logo)
newax.axis('off')

# Add a legend to the plot
my_legend = plt.imread(main_dir + '//Legends//SAL_legend.webp')
newax = fig.add_axes([0.69, 0.67, 0.30, 0.30], anchor='NE', zorder=11) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
