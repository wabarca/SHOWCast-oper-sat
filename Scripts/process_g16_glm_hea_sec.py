...
if (seconds == '00'):
    ...
    if (int(minutes) % acum_minutes == 0):
        ...
        "dpi": 150,
        "states_color": 'white', "states_width": sizey * 0.004,
        "countries_color": 'white', "countries_width": sizey * 0.004,
        "continents_color": 'white', "continents_width": sizey * 0.004,
        "grid_color": 'white', "grid_width": sizey * 0.00025, "grid_interval": 5.0,
        "title_text": "GOES-19 GLM (Heatmap)", "title_size": int(sizex * 0.03), "title_x_offset": int(sizex * 0.01), "title_y_offset": sizey - int(sizey * 0.016),
        ...
        glm = ax.imshow(heatmap, vmin=0, vmax=40, interpolation='bilinear', extent=extent_glm, origin='lower', cmap=my_cmap, transform=ccrs.PlateCarree(), alpha = 0.5, zorder=4)
