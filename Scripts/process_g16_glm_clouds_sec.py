...
img1 = ax.pcolormesh(lons_file, lats_file, mout1, shading='None', vmin=0, vmax=4, alpha=0.4, cmap='RdYlGn_r', transform=ccrs.PlateCarree(), zorder=10)
img2 = ax.pcolormesh(lons_file, lats_file, mout2, shading='None', vmin=0, vmax=4, alpha=0.6, cmap='RdYlGn_r', transform=ccrs.PlateCarree(), zorder=11)
img3 = ax.pcolormesh(lons_file, lats_file, mout3, shading='None', vmin=0, vmax=50, alpha=0.8, cmap='RdYlGn_r', transform=ccrs.PlateCarree(), zorder=12)
...
# Add a title
plt.annotate(plot_config["title_text"] + " " + date_formated , xy=(0.015,0.965), xycoords='figure fraction', fontsize=plot_config["title_size"], fontweight='bold', color='white', bbox=dict(boxstyle="round",fc=(0.0, 0.0, 0.0), ec=(1., 1., 1.)), zorder=14)
