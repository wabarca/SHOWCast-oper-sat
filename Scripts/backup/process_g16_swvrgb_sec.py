...
"title_text": "GOES-" + satellite[1:3] + " Simple Water Vapor RGB (Vapor de agua)", "title_size": 8, "title_x_offset": int(data_ch10.shape[1] * 0.01), "title_y_offset": data_ch10.shape[0] - int(data_ch10.shape[0] * 0.016), 
"thick_interval": 0, "cbar_labelsize": 8, "cbar_labelpad": -int(data_ch10.shape[0] * 0.0),
...
gl.xpadding = -2
gl.ypadding = -2
gl.xlabel_style = {'size': 6, 'weight': 'bold', 'color': 'silver'}
gl.ylabel_style = {'size': 6, 'weight': 'bold', 'color': 'silver'}
...
my_legend = plt.imread(main_dir + '//Legends//SIMPLEWATERVAPOR_legend.webp')
