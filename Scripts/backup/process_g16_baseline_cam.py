...
if (variable == 'HT'):  
    ...
    "dpi": 150, 
    "states_color": 'yellow', "states_width": data.shape[0] * 0.02, 
    "countries_color": 'yellow', "countries_width": data.shape[0] * 0.02,
    "continents_color": 'yellow', "continents_width": data.shape[0] * 0.02,
    "grid_color": 'white', "grid_width": data.shape[0] * 0.00025, "grid_interval": 10.0,
    "vmin": vmin, "vmax": vmax, "cmap": cmap,
    "title_text": "GOES-16 " + prod_name + " [m]", "title_size": int(data.shape[1] * 0.15), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
    "thick_interval": thick_interval, "cbar_labelsize": int(data.shape[0] * 0.25), "cbar_labelpad": -int(data.shape[0] * 0.0),
    ...
    "resolution": band_resolution_km, 
    "dpi": 150, 
    "states_color": 'yellow', "states_width": data.shape[0] * 0.004, 
    "countries_color": 'yellow', "countries_width": data.shape[0] * 0.004,
    "continents_color": 'yellow', "continents_width": data.shape[0] * 0.004,
    "grid_color": 'white', "grid_width": data.shape[0] * 0.00025, "grid_interval": 10.0,
    "vmin": vmin, "vmax": vmax, "cmap": cmap,
    "title_text": "GOES-16 " + prod_name + " [C]", "title_size": int(data.shape[1] * 0.03), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
    "thick_interval": thick_interval, "cbar_labelsize": int(data.shape[0] * 0.05), "cbar_labelpad": -int(data.shape[0] * 0.0),
    "file_name_id_1": "G16",  "file_name_id_2": product 
    }
    #------------------------------------------------------------------------------------------------------
elif (variable == 'BCM'): 
    ...
    "grid_color": 'white', "grid_width": data.shape[0] * 0.00025, "grid_interval": 10.0,
    "vmin": vmin, "vmax": vmax, "cmap": cmap,
    "title_text": "GOES-16 " + prod_name, "title_size": int(data.shape[1] * 0.03), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
    "thick_interval": thick_interval, "cbar_labelsize": int(data.shape[0] * 0.05), "cbar_labelpad": -int(data.shape[0] * 0.0),
    "file_name_id_1": "G16",  "file_name_id_2": product 
    }
    #------------------------------------------------------------------------------------------------------
    ...
    "grid_color": 'white', "grid_width": data.shape[0] * 0.00025, "grid_interval": 10.0,
    "vmin": vmin, "vmax": vmax, "cmap": cmap,
    "title_text": "GOES-16 " + prod_name + " [C]", "title_size": int(data.shape[1] * 0.15), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
    "thick_interval": thick_interval, "cbar_labelsize": int(data.shape[0] * 0.25), "cbar_labelpad": -int(data.shape[0] * 0.0),
    "file_name_id_1": "G16",  "file_name_id_2": product 
    }
    #------------------------------------------------------------------------------------------------------
    ...
    "resolution": band_resolution_km, 
    "dpi": 150, 
    "states_color": 'dimgray', "states_width": data.shape[0] * 0.000125, 
    "countries_color": 'dimgray', "countries_width": data.shape[0] * 0.000125,
    "continents_color": 'dimgray', "continents_width": data.shape[0] * 0.000125,
    "grid_color": 'gray', "grid_width": data.shape[0] * 0.00025, "grid_interval": 5.0,
    "vmin": vmin, "vmax": vmax, "cmap": cmap,
    "title_text": "GOES-16 " + prod_name + " [mm/h] + NHC", "title_size": int(data.shape[1] * 0.0025), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
    ...
    "grid_color": 'white', "grid_width": data.shape[0] * 0.00025, "grid_interval": 10.0,
    "vmin": vmin, "vmax": vmax, "cmap": cmap,
    "title_text": "GOES-16 " + prod_name + " [mm]", "title_size": int(data.shape[1] * 0.15), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
    "thick_interval": thick_interval, "cbar_labelsize": int(data.shape[0] * 0.25), "cbar_labelpad": -int(data.shape[0] * 0.0),
    "file_name_id_1": "G16",  "file_name_id_2": product 
    }
    #------------------------------------------------------------------------------------------------------
...
for pl in points_low:
    ...
    if float(pl.attributes['PROB7DAY'].replace("%", "")) < 40:
        ...
        text = ax.text(pl.geometry.x+0.5,pl.geometry.y-0.5,'7d: '+pl.attributes['PROB7DAY'],color='orange', fontsize='large', fontweight='bold',zorder=5)
        text.set_path_effects([PathEffects.withStroke(linewidth=1.5, foreground='k')])
    else:
        text = ax.text(pl.geometry.x+0.5,pl.geometry.y-0.5,'7d: '+pl.attributes['PROB7DAY'],color='red', fontsize='large', fontweight='bold',zorder=5)
        text.set_path_effects([PathEffects.withStroke(linewidth=1.5, foreground='k')])
...
for pm in points_medium:
    ...
    if float(pm.attributes['PROB7DAY'].replace("%", "")) < 40:
        text = ax.text(pm.geometry.x+0.5,pm.geometry.y-0.5,'7d: '+pm.attributes['PROB7DAY'],color='gold', fontsize='large', fontweight='bold',zorder=5)
        text.set_path_effects([PathEffects.withStroke(linewidth=1.5, foreground='k')])
        ...
        text = ax.text(pm.geometry.x+0.5,pm.geometry.y-0.5,'7d: '+pm.attributes['PROB7DAY'],color='red', fontsize='large', fontweight='bold',zorder=5)
        text.set_path_effects([PathEffects.withStroke(linewidth=1.5, foreground='k')])
...
for ph in points_high:
    ...
    if float(ph.attributes['PROB7DAY'].replace("%", "")) < 40:
        text = ax.text(ph.geometry.x+0.5,ph.geometry.y-0.5,'7d: '+ph.attributes['PROB7DAY'],color='gold', fontsize='large', fontweight='bold',zorder=5)
        text.set_path_effects([PathEffects.withStroke(linewidth=1.5, foreground='k')])
    elif float(ph.attributes['PROB7DAY'].replace("%", "")) >= 40 and float(ph.attributes['PROB7DAY'].replace("%", "")) <= 60:
        text = ax.text(ph.geometry.x+0.5,ph.geometry.y-0.5,'7d: '+ph.attributes['PROB7DAY'],color='orange', fontsize='large', fontweight='bold',zorder=5)
        text.set_path_effects([PathEffects.withStroke(linewidth=1.5, foreground='k')])
    else:
...
newax = fig.add_axes([0.01, 0.04, 0.10, 0.10], anchor='SW', zorder=14) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
