...
"title_text": "GOES-" + satellite[1:3] + " Color falso ", "title_size": 8, "title_x_offset": int(data_ch02.shape[1] * 0.01), "title_y_offset": data_ch02.shape[0] - int(data_ch02.shape[0] * 0.016), 
...
newax = fig.add_axes([0.84, 0.02, 0.15, 0.15], anchor='SW', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
