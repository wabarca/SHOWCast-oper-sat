...
"title_text": "GOES-" + satellite[1:3] + " Night Microphysics RGB (Microfísica nocturna)", "title_size": 8, "title_x_offset": int(data_ch13.shape[1] * 0.01), "title_y_offset": data_ch13.shape[0] - int(data_ch13.shape[0] * 0.016), 
...
my_legend = plt.imread(main_dir + '//Legends//NIGHTMICROPHYSICS_legend.webp')
