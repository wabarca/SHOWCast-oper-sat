...
"title_text": "GOES-" + satellite[1:3] + " Day Land Cloud RGB", "title_size": 8, "title_x_offset": int(data_ch05.shape[1] * 0.01), "title_y_offset": data_ch05.shape[0] - int(data_ch05.shape[0] * 0.016), 
...
my_legend = plt.imread(main_dir + '//Legends//DAYLANDCLOUD_legend.webp')
