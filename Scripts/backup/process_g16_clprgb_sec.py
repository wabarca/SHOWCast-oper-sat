...
plot_config = {
    ...
    "title_text": "GOES-" + satellite[1:3] + " Cloud Phase RGB (Fase de nube)", "title_size": 8, "title_x_offset": int(data_ch05.shape[1] * 0.01), "title_y_offset": data_ch05.shape[0] - int(data_ch05.shape[0] * 0.016), 
    "thick_interval": 0, "cbar_labelsize": 8, "cbar_labelpad": -int(data_ch05.shape[0] * 0.0),
...
my_legend = plt.imread(main_dir + '//Legends//CLOUDPHASE_legend.webp')
newax = fig.add_axes([0.60, 0.58, 0.39, 0.39], anchor='NE', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
