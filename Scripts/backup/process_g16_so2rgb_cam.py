...
"dpi": 150, 
"states_color": 'gold', "states_width": data_ch09.shape[0] * 0.0005, 
"countries_color": 'gold', "countries_width": data_ch09.shape[0] * 0.0005,
"continents_color": 'gold', "continents_width": data_ch09.shape[0] * 0.0005,
"grid_color": 'white', "grid_width": data_ch09.shape[0] * 0.0005, "grid_interval": 5.0,
...
"thick_interval": 0, "cbar_labelsize": int(data_ch09.shape[0] * 0.01), "cbar_labelpad": -int(data_ch09.shape[0] * 0.0),
