...
"title_text": "GOES-16 GLM  Descargas eléctricas (20s)", "title_size": 8, "title_x_offset": int(sizex * 0.01), "title_y_offset": sizey - int(sizey * 0.016), 
...
land = ax.add_feature(cfeature.LAND, facecolor='dimgray', zorder=1)
ocean = ax.add_feature(cfeature.OCEAN, facecolor='dimgray', zorder=2)
...
img3 = ax.plot(g_lons,g_lats, '.', markersize=2.5, color='blue', alpha = 1.0, transform=ccrs.PlateCarree(), zorder=5)
...
newax = fig.add_axes([0.8925, 0.01, 0.10, 0.10], anchor='SE', zorder=12) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
