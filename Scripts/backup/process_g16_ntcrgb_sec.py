...
"title_text": "GOES-" + satellite[1:3] + " Natural True Color RGB (Color natural)", "title_size": 8, "title_x_offset": int(data_ch01.shape[1] * 0.01), "title_y_offset": data_ch01.shape[0] - int(data_ch01.shape[0] * 0.016), 
...
# my_legend = plt.imread(main_dir + '//Legends//NATURALTRUECOLOR_legend.webp')
