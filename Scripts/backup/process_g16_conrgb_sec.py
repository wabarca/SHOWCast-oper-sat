...
plot_config = {
    ...
    "title_text": "GOES-" + satellite[1:3] + " Day Convection RGB (Convección diurna)", "title_size": 8, "title_x_offset": int(data_ch08.shape[1] * 0.01), "title_y_offset": data_ch08.shape[0] - int(data_ch08.shape[0] * 0.016), 
...
my_legend = plt.imread(main_dir + '//Legends//DAYCONVECTION_legend.webp')
