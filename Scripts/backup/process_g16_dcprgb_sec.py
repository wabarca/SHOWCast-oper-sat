...
plot_config = {
    ...
    "title_text": "GOES-" + satellite[1:3] + " Day Cloud Phase Distinction RGB (Distinción de fase de nube diurna)", "title_size": 8, "title_x_offset": int(data_ch13.shape[1] * 0.01), "title_y_offset": data_ch13.shape[0] - int(data_ch13.shape[0] * 0.016), 
    "thick_interval": 0, "cbar_labelsize": int(data_ch13.shape[0] * 0.05), "cbar_labelpad": 8,
...
my_legend = plt.imread(main_dir + '//Legends//DAYCLOUDPHASE_legend.webp')
