...
"dpi": 150, 
"states_color": 'gold', "states_width": data_ch01.shape[0] * 0.00025, 
"countries_color": 'gold', "countries_width": data_ch01.shape[0] * 0.00025,
"continents_color": 'gold', "continents_width": data_ch01.shape[0] * 0.00025,
"grid_color": 'white', "grid_width": data_ch01.shape[0] * 0.00025, "grid_interval": 5.0,
"vmin": 0, "vmax": 1, "cmap": 'jet',
"title_text": "GOES-" + satellite[1:3] + " Natural True Color RGB ", "title_size": int(data_ch01.shape[1] * 0.0025), "title_x_offset": int(data_ch01.shape[1] * 0.01), "title_y_offset": data_ch01.shape[0] - int(data_ch01.shape[0] * 0.016), 
