...
if int(band) == 1 or int(band) == 2 or int(band) == 3 or int(band) == 5:
    ...
    "dpi": 150, 
    "states_color": 'gold', "states_width": data.shape[0] * 0.00025, 
    "countries_color": 'gold', "countries_width": data.shape[0] * 0.00025,
    ...
    "title_text": "GOES-" + satellite[1:3] + " Band " + band, "title_size": int(data.shape[1] * 0.0025), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
    ...
    "resolution": band_resolution_km, 
    "dpi": 150, 
    "states_color": 'gold', "states_width": data.shape[0] * 0.0005, 
    "countries_color": 'gold', "countries_width": data.shape[0] * 0.0005,
    "continents_color": 'gold', "continents_width": data.shape[0] * 0.0005,
    "grid_color": 'white', "grid_width": data.shape[0] * 0.0005, "grid_interval": 5.0,
    "vmin": vmin, "vmax": vmax, "cmap": cmap,
    "title_text": "GOES-" + satellite[1:3] + " Band " + band, "title_size": int(data.shape[1] * 0.005), "title_x_offset": int(data.shape[1] * 0.02), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
    "thick_interval": thick_interval, "cbar_labelsize": int(data.shape[0] * 0.01), "cbar_labelpad": -int(data.shape[0] * 0),
    "file_name_id_1": satellite,  "file_name_id_2": product 
    }
#---------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------
