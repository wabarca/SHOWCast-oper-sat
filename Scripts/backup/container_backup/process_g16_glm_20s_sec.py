...
"dpi": 150, 
"states_color": 'white', "states_width": 0.4, 
"countries_color": 'white', "countries_width": 0.4,
"continents_color": 'white', "continents_width": 0.4,
"grid_color": 'white', "grid_width": 0.3, "grid_interval": 1.0,
"title_text": "GOES-16 GLM Grupos (20s)", "title_size": 8, "title_x_offset": int(sizex * 0.01), "title_y_offset": sizey - int(sizey * 0.016), 
...
img3 = ax.plot(g_lons,g_lats, '.', markersize=3,color='#005aff',alpha = 0.75, transform=ccrs.PlateCarree(), zorder=5)
