...
"title_text": "GOES-" + satellite[1:3] + " Band " + band + " IR CLOUDS ENHANCED", "title_size": 8, "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
