...
"title_text": "GOES-" + satellite[1:3] + " SO2 RGB (Detección de dióxido de azufre)", "title_size": 8, "title_x_offset": int(data_ch09.shape[1] * 0.01), "title_y_offset": data_ch09.shape[0] - int(data_ch09.shape[0] * 0.016), 
"thick_interval": 0, "cbar_labelsize": 8, "cbar_labelpad": -int(data_ch09.shape[0] * 0.0),
...
my_legend = plt.imread(main_dir + '//Legends//SO2_legend.webp')
