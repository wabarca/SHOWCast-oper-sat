...
# B = data_ch08
# RGB Components (Tropical Airmass RGB)
R = data_ch08 - data_ch13
G = data_ch12 - data_ch13
B = data_ch08
...
# Bmin = -29.25
# Bmax = -64.65
# Minimuns and Maximuns (Tropical Airmass RGB)
Rmin = -25
Rmax = 5
...
"title_text": "GOES-" + satellite[1:3] + " Overshooting Tops RGB (Tormentas severas)", "title_size": 8, "title_x_offset": int(data_ch08.shape[1] * 0.01), "title_y_offset": data_ch08.shape[0] - int(data_ch08.shape[0] * 0.016), 
"thick_interval": 0, "cbar_labelsize": 8, "cbar_labelpad": -int(data_ch08.shape[0] * 0.0),
...
# my_legend = plt.imread(main_dir + '//Legends//AIRMASS_legend.webp')
# newax = fig.add_axes([0.55, 0.54, 0.44, 0.44], anchor='NE', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
