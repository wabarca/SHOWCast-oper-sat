...
"title_text": "GOES-16 " + prod_name + " ["+variable_units+"]", "title_size": 8, "title_x_offset": int(sizex * 0.01), "title_y_offset": sizey - int(sizey * 0.016), 
...
img = ax.pcolormesh(lons, lats, data, vmin=plot_config["vmin"], vmax=plot_config["vmax"], cmap=plot_config["cmap"],transform=ccrs.PlateCarree(), zorder=2)
