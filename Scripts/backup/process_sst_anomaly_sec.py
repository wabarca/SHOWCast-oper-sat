...
cb.set_label(label='Anomalía de Temperatura de la Superficie del Mar - Sea Surface Temperature Anomalies (°C)', color='Black', size=plot_config["title_size"], weight='bold')
