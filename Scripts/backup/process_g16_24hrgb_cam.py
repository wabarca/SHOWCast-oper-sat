...
"dpi": 150, 
"states_color": 'gold', "states_width": data_ch15.shape[0] * 0.0005, 
"countries_color": 'gold', "countries_width": data_ch15.shape[0] * 0.0005,
"continents_color": 'gold', "continents_width": data_ch15.shape[0] * 0.0005,
"grid_color": 'white', "grid_width": data_ch15.shape[0] * 0.0005, "grid_interval": 5.0,
"vmin": 0, "vmax": 1, "cmap": 'jet',
"title_text": "GOES-" + satellite[1:3] + " 24h Microphysics RGB ", "title_size": int(data_ch15.shape[1] * 0.005), "title_x_offset": int(data_ch15.shape[1] * 0.01), "title_y_offset": data_ch15.shape[0] - int(data_ch15.shape[0] * 0.016), 
"thick_interval": 0, "cbar_labelsize": int(data_ch15.shape[0] * 0.01), "cbar_labelpad": -int(data_ch15.shape[0] * 0.0),
