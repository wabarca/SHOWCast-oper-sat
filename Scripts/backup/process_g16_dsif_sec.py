...
def procDsif(variable,product):
    ...
    "resolution": 8, 
    "dpi": 150, 
    "states_color": 'white', "states_width": data.shape[0] * 0.02, 
    "countries_color": 'gold', "countries_width": data.shape[0] * 0.02,
    "continents_color": 'gold', "continents_width": data.shape[0] * 0.02,
    "grid_color": 'white', "grid_width": data.shape[0] * 0.00025, "grid_interval": 10.0,
    "vmin": vmin, "vmax": vmax, "cmap": cmap,
    "title_text": "GOES-16 " + prod_name + " " + variable, "title_size": int(data.shape[0] * 0.26), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
