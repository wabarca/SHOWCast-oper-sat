...
newax = fig.add_axes([0.84, 0.05, 0.15, 0.15], anchor='SW', zorder=8) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
...
cb.set_label(label='Fracción de vegetación verde (GVF)', color='white', size=plot_config["title_size"], weight='bold')
