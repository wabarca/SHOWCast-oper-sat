...
"title_text": "GOES-" + satellite[1:3] + " True Color RGB ", "title_size": int(data_ch01.shape[1] * 0.0025), "title_x_offset": int(data_ch01.shape[1] * 0.01), "title_y_offset": data_ch01.shape[0] - int(data_ch01.shape[0] * 0.016), 
...
if (satellite == 'G16'):
    conf.read(main_dir + '//Utils//Labels//labels_g16_cam_cam_cam.ini')
elif (satellite == 'G17'):
