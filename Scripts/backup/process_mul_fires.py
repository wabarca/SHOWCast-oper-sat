...
with fiona.open(path_shape) as input:
    ...
    with fiona.open(path_shp_clip,'w',**meta) as output:
        for feature in input:
            if (feature['properties']['latitude'] <= 18.45 and feature['properties']['latitude'] >= 7) and (feature['properties']['longitude'] <= -77.0 and feature['properties']['longitude'] >= -92.15):
...
import subprocess
subprocess.run(["scp", path_csv_clip, "ccpm@192.168.4.28:/var/www/html/gnca_fireshotspots/"])
subprocess.run(["scp", path_cpg_clip, "ccpm@192.168.4.28:/var/www/html/gnca_fireshotspots/shapefiles/"])
subprocess.run(["scp", path_dbf_clip, "ccpm@192.168.4.28:/var/www/html/gnca_fireshotspots/shapefiles/"])
subprocess.run(["scp", path_prj_clip, "ccpm@192.168.4.28:/var/www/html/gnca_fireshotspots/shapefiles/"])
subprocess.run(["scp", path_shx_clip, "ccpm@192.168.4.28:/var/www/html/gnca_fireshotspots/shapefiles/"])
subprocess.run(["scp", path_shp_clip, "ccpm@192.168.4.28:/var/www/html/gnca_fireshotspots/shapefiles/"])
