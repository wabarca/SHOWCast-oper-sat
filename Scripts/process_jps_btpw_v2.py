...
"thick_interval": thick_interval, "cbar_labelsize": 7, "cbar_labelpad": -int(data.shape[0] * 0.0),
...
newax = fig.add_axes([0.9, 0.0, 0.10, 0.10], anchor='S', zorder=6) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
