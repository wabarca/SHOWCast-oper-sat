...
# ingest_dir = 'C://GNC-A//incoming//'      # Windows Example - Change it according to your GNC-A Station
# ingest_dir = '//192.168.41.124//incoming//'      # Windows Example - Change it according to your GNC-A Station
...
if osystem == "Windows":
    python_env = showcast_dir + '//Miniconda3//envs//showcast2//' 
else:
    python_env = showcast_dir + '//Miniconda3//envs//showcast2//bin//' 
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------
# QT Plugin path
