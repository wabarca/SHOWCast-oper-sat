...
# ingest_dir = 'E://workspace//GNC-A//incoming//'      # Windows Example - Change it according to your GNC-A Station
# ingest_dir = '//192.168.x.x//incoming//'      # Windows Example - Change it according to your GNC-A Station
ingest_dir = '/home/geonetcast/GNC-A/incoming/'       # Linux Example - Change it according to your GNC-A Station 
...
if osystem == "Windows":
    ...
    python_env = 'C://Users//will_//miniconda3//envs//showcast//' 
    # python_env = 'C://Users//wabarca//miniconda3//envs//showcast//' 
else:
    # python_env = showcast_dir + '//Miniconda3//envs//showcast//bin//' 
    python_env = '//home//geonetcast//miniconda3//envs//showcast//bin//' 
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------
# QT Plugin path
